...
const templates: TemplateOption[] = [
  ...
  },
  {
    ...
    description:
      "A completely clean, blank workspace with a fresh package.json. Best for configuring everything yourself from scratch.",
    icon: "/logo.svg",
    color: "#E93F3F",
    popularity: 5,
    tags: ["Custom", "Clean", "Fresh"],
    features: [
      "Zero Boilerplate",
      "Fresh package.json",
                        ...
                        <div className="flex gap-4">
                          ...
                          >
                            {template.id === "blank" ? (
                              ...
                              <Server size={30} className="text-slate-700 dark:text-slate-200" />
                            ) : (
                              <Image
